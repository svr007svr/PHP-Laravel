            ...
            <div class="col-md-8 col-xl-6 mx-auto">
              ...
              <article class="my-8">
                <header class="text-center mb-7">
                  <p><a class="small-4 text-lighter text-uppercase ls-2 fw-600" href="#">News</a></p>
                  <h3><a href="post-2.html">We relocated our office to a new garage</a></h3>
                </header>

                <a href="post-2.html"><img class="rounded-md" src="../assets/img/thumb/1.jpg" alt="..."></a>
              ...
              <article class="my-8">
                <header class="text-center mb-7">
                  <p><a class="small-4 text-lighter text-uppercase ls-2 fw-600" href="#">Marketing</a></p>
                  <h3><a href="post-2.html">Top 5 brilliant content marketing strategies</a></h3>
                </header>

                <a href="post-2.html"><img class="rounded-md" src="../assets/img/thumb/2.jpg" alt="..."></a>
                ...
                <div class="card-body">
                  <div class="row mb-5 small-2 text-lighter">
                    ...
                    <div class="col-auto ml-auto">
                      ...
                      <a class="text-inherit ml-5" href="#"><i class="fa fa-comments pr-1 opacity-60"></i> 3</a>
                    </div>
                  </div>
              ...
              <article class="my-8">
                <header class="text-center mb-7">
                  <p><a class="small-4 text-lighter text-uppercase ls-2 fw-600" href="#">Design</a></p>
                  <h3><a href="post-2.html">Best practices for minimalist design</a></h3>
                </header>

                <a href="post-2.html"><img class="rounded-md" src="../assets/img/thumb/3.jpg" alt="..."></a>
                ...
                <div class="card-body">
                  <div class="row mb-5 small-2 text-lighter">
                    ...
                    <div class="col-auto ml-auto">
                      ...
                      <a class="text-inherit ml-5" href="#"><i class="fa fa-comments pr-1 opacity-60"></i> 9</a>
                    </div>
                  </div>
              ...
              <article class="my-8">
                <header class="text-center mb-7">
                  <p><a class="small-4 text-lighter text-uppercase ls-2 fw-600" href="#">Hiring</a></p>
                  <h3><a href="post-2.html">Congratulate and thank to Maryam for joining our team</a></h3>
                </header>

                <a href="post-2.html"><img class="rounded-md" src="../assets/img/thumb/4.jpg" alt="..."></a>
                ...
                <div class="card-body">
                  <div class="row mb-5 small-2 text-lighter">
                    ...
                    <div class="col-auto ml-auto">
                      ...
                      <a class="text-inherit ml-5" href="#"><i class="fa fa-comments pr-1 opacity-60"></i> 4</a>
                    </div>
                  </div>
              ...
              <article class="my-8">
                <header class="text-center mb-7">
                  <p><a class="small-4 text-lighter text-uppercase ls-2 fw-600" href="#">Product</a></p>
                  <h3><a href="post-2.html">New published books to read by a product designer</a></h3>
                </header>

                <a href="post-2.html"><img class="rounded-md" src="../assets/img/thumb/5.jpg" alt="..."></a>
                ...
                <div class="card-body">
                  <div class="row mb-5 small-2 text-lighter">
                    ...
                    <div class="col-auto ml-auto">
                      ...
                      <a class="text-inherit ml-5" href="#"><i class="fa fa-comments pr-1 opacity-60"></i> 16</a>
                    </div>
                  </div>
              ...
              <nav class="flexbox my-8">
                <a class="btn btn-outline-secondary disabled"><i class="ti-arrow-left fs-9 mr-2"></i> Newer</a>
                <a class="btn btn-outline-secondary" href="#">Older <i class="ti-arrow-right fs-9 ml-2"></i></a>
              </nav>
            </div>
          </div>
